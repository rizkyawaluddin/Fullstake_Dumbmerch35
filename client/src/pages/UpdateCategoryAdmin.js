    ...
    <div className="container">
      ...
      <form onSubmit={(e) => handleSubmit.mutate(e)} style={{ marginTop: "3rem" }}>
        <div className="input-group mb-3">
          <input name="name" onChange={handleChange}  type="text" className="form-control bg-var-dark text-white border-form" />
        </div>
        <button type="submit" className="btn bg-var-green text-white fw-bold container mt-5">Save</button>
      </form>
    </div>
  );
};
